...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Affis Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=554191721216:+55 41 99172-1216\n' 
            + 'END:VCARD' 
prefix = '!'
blocked = []          
...
const config = {
    XBOT: 'ʙᴏᴛ ᴅᴏ ᴀᴢᴀʀᴋ ᴏғғ', 
    instagram: 'https://www.instagram.com/kaic_de_paula?r=nametag', 
    nomer: 'wa.me/5541991721216',
    youtube: 'https://youtube.com/channel/UCNqWLRIo3pHuQ4n8IucUATA', 
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				wait: '❬❗❭AGUARDE ENQUANTO UM POUCO ❬❗❭',
				success: '️❬ ✔ ❭ PRONTO 😊',
				error: {
...
case 'lofi':
                ...
                case 'reportarbug':
                    ...
                    client.sendMessage('5541991721216@s.whatsapp.net', options, text, {quoted: mek})
                    reply('PDP PARSA, BUG FOI REPORTADO, SE FOR MENTIRA SEUS DADOS VAI SER PUXADO🙄✌🏼')
                    break
					case 'marcar':
					members_id = []
            ...
            case 'criador':
            case 'ᴀᴢᴀʀᴋ ᴏғғ':
                  client.sendMessage(from, {displayname: "azark adm", vcard: vcard}, MessageType.contact, { quoted: mek})
